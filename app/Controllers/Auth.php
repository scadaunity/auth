...
class Auth extends BaseController
{
    ...
    {
        echo view('Auth/template/header');
        echo view('Auth/login');
        echo view('Auth/template/footer');
    }
    ...
    // Envia um email para o usuario poder resetar o password da conta
    private function sendEmailTryLogin($email)
    {
        /* Configura o modulo */
        $config = array(
            'protocol' => 'smtp',
        ...
        $this->email->setSubject('Recuperar sua senha');
        $this->email->setMessage('Houve uma tentativa de acesso a sua conta, foi voce');
