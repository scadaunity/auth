    ...
    <div class="scrollbar-inner">
        ...
        <ul class="navigation">
            ...
            <li class="navigation__sub @@variantsactive">
                <a href="#"><i class="zmdi zmdi-accounts"></i> User and Roles</a>
                <ul>
                    <li class=""><a href="hidden-sidebar.html">Users</a></li>
                    <li class="@@boxedactive"><a href="boxed-layout.html">Roles</a></li>
                </ul>
            </li>
        </ul>
    </div>
